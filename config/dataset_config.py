...
dataset_config = {
    'ucf24': {
        # dataset
        'gt_folder': '/home/su/YOWOv3/evaluator/groundtruths_ucf_jhmdb/groundtruths_ucf',  # 测试集的标注，共计137557项/帧
        # input size
        'train_size': 224,
        'test_size': 224,
        # transform
    ...
    'jhmdb21': {
        # dataset
        'gt_folder': '/home/su/YOWOv3/evaluator/groundtruths_ucf_jhmdb/groundtruths_jhmdb',
        # input size
        'train_size': 224,
        'test_size': 224,
        # transform
    ...
    'multisports': {
        ...
        'wp_iter': 500,
        # class names
        'valid_num_classes': 60,
        'label_map': ('aerobic push up', 'aerobic explosive push up', 'aerobic explosive support', 'aerobic leg circle',
                      'aerobic helicopter', 'aerobic support', 'aerobic v support', 'aerobic horizontal support',
                      'aerobic straight jump', 'aerobic illusion', 'aerobic bent leg(s) jump', 'aerobic pike jump',
                      'aerobic straddle jump', 'aerobic split jump', 'aerobic scissors leap', 'aerobic split',
                      'aerobic turn', 'volleyball serve', 'volleyball block', 'volleyball first pass',
                      'volleyball defend', 'volleyball protect', 'volleyball second pass', 'volleyball adjust',
                      'volleyball save', 'volleyball second attack', 'volleyball spike', 'volleyball dink',
                      'volleyball no offensive attack', 'football shoot', 'football long pass', 'football short pass',
                      'football through pass', 'football cross', 'football dribble', 'football trap', 'football throw',
                      'football diving', 'football tackle', 'football steal', 'football clearance', 'football block',
                      'football press', 'football aerial duels', 'basketball pass', 'basketball drive',
                      'basketball dribble', 'basketball 3-point shot', 'basketball 2-point shot',
                      'basketball free throw', 'basketball block', 'basketball offensive rebound',
                      'basketball defensive rebound', 'basketball pass steal', 'basketball dribble steal',
                      'basketball interfere shot', 'basketball pick-and-roll defensive', 'basketball sag',
                      'basketball screen', 'basketball pass-inbound'),
    },
}
