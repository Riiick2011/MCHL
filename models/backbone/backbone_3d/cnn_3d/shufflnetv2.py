...
weight_pth = {
    "0.25x": '/home/su/YOWOv3/weights/kinetics_shufflenetv2_0.25x_RGB_16_best.pth',
    "1.0x": '/home/su/YOWOv3/weights/kinetics_shufflenetv2_1.0x_RGB_16_best.pth',
    "1.5x": '/home/su/YOWOv3/weights/kinetics_shufflenetv2_1.5x_RGB_16_best.pth',
    "2.0x": '/home/su/YOWOv3/weights/kinetics_shufflenetv2_2.0x_RGB_16_best.pth',
}
...
def load_weight(model, arch):
    ...
    checkpoint = torch.load(weight_pth[arch])
